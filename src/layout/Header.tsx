            ...
            <div className={classes.navCont}>
              {
                ...
                //on mobile tablet
                  ...
                  <>
                   <ButtonContainer>
                    <HollowButton style={{color:'#8687FF', fontWeight: '500', fontFamily:'Lato'}}> Log in </HollowButton>
                    <FilledButton style={{  margin: '23px', fontFamily:'Lato'}}> Tutorial </FilledButton>
                  </ButtonContainer>
                </>
              }
